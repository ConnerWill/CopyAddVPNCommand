...
> *AutoHotKey script for simply copying the PowerShell commands needed to create a VPN connection on a windows computer. Very helpful for Helpdesk scenarios.*
>>>>>>> c0155e1d4efbeecb78ae2579bd160e6bca9b7369
...
1. Install [AutoHotKey](https://autohotkey.com) if you havent already
2. Clone this repository:
```console
$  git clone https://github.com/ConnerWill/CopyAddVPNCommand.git
```
3. Run [`CopyAddVPNCommand.ahk`](https://github.com/ConnerWill/CopyAddVPNCommand/blob/main/CopyAddVPNCommand.ahk)
